...
// IsRSAE returns true if the algorithm is an rsaEncryption-based PSS scheme.
// These use keys with rsaEncryption OID (1.2.840.113549.1.1.1).
func (a Algorithm) IsRSAE() bool {
	return a == RSA_PSS_RSAE_SHA256 ||
		a == RSA_PSS_RSAE_SHA384 ||
		a == RSA_PSS_RSAE_SHA512
}
